...
const services = [
  {
    ...
    description:
      "A Coin is the native digital currency of the ecosystem — designed to empower Africa's youth with a decentralised store of value, reward mechanism, and investment vehicle.",
    highlights: [
  ...
  },
  {
    ...
    description:
      "A SPHARE is our flagship community platform — a social hub for African youth to share ideas, collaborate on ventures, access educational content, and build meaningful networks.",
    highlights: [
    ...
    link: "https://ayi-space.vercel.app",
    comingSoon: false,
  },
  {
    id: "ayi-wallet",
    ...
    description:
      "A Wallet is the all-in-one financial layer of the ecosystem — enabling seamless saving, money transfers, investment tracking, and mobile money integration tailored for African youth.",
    highlights: [
    ...
    link: "https://ayi-wallet.vercel.app",
    comingSoon: false,
  },
  {
